...
punto1 = input('Introduzca los valores x_1 y y_1 separados por una coma\n').split(',')
punto2 = input('Introduzca los valores x_2 y y_2 separados por una coma\n').split(',')

objetivo = input('Introduzca el punto que quiera interpolar:\n')

interpolacion = interpol(punto1, punto2, objetivo)

print(f'El valor en el punto {objetivo} es {interpolacion}')